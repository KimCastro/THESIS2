...
$query = "SELECT * FROM rooms where RoomType = 'quad' and RoomStatus = 'Available'";
...
<a href="roomavailabilityquad.php">Quad</a>
                   ...
                   <article>  
                               <form class = "form" action="roomavailability.php" method = "post" >
                                <div style="border:1px solid teal; padding:10px; border-radius:1em;  font-size:20px;">
                                 ...
                                 <?php echo "<img width='170' height ='170' src='room/Quad/".$row['Img']." ' alt='Profile pic'>"; ?>  
                            ...
                            Room Floor: <input type="text" name="floor" value = "<?php echo($row['RoomFloor']);?>"  style=" border:none; background:transparent;  font-weight: bold;"readonly> 
                               ...
                               Room Rate.: <input type="text" name="number"  value = "<?php echo ($row['RoomRates']);?>"  style=" border:none; background:transparent;  font-weight: bold; " readonly>
                              

                              <input style="background-color: green; color:white; height:50px;width:90px;" type="submit" name="Delete"  value = "Book now" >
