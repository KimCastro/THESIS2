...
<body>
  ...
  <!-- end of navigation bar -->
    ...
    <center><img src="img/steps/step3.png" alt="step2"/></center><hr noshade>
    </header>
    ...
    <hr />
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" class="validate" style="color:black">
          <label for="icon_prefix">First Name</label>
        </div>
        <div class="input-field col s6">
          <i class="material-icons prefix">account_circle</i>
          <input id="icon_prefix" type="tel" class="validate"  style="color:black">
 ...
 <div class="col s3">
        ...
        <p  class="grey col s6" style="padding:10px; ">Check-in </p>
        <p class="grey " style="padding:10px; ">Check-out:  </p>
        <p class="grey" style="padding:10px;"> Type of Room:  </p>
        <p  class="grey" style="padding:10px; ">Number of Room(s): </p>
        <p class="grey" style="padding:10px; "> Number of night(s): </p>
        <p class="grey col s6" style="padding:10px; ">Number of Adult(s): </p>
        <p  class="grey" style="padding:10px;" > Number of Child(ren):  </p> 
        </div>
        </div>
    ...
    <div class="card grey darken-2">
      <div class="card-content white-text" align="center"> 
       <div class=" input-field col s12">
        ...
        <p  class="grey" style="padding:10px; ">Charge per room: </p>
        <p class="grey " style="padding:10px; ">Total Charge: </p>
        <hr />
        <p class="grey" style="padding:10px;">Amount of Deposit: </p>
        <p  class="grey" style="padding:10px; ">Remaining Balance:</p>         
