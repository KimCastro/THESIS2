...
<ul id="dropdown2" class="dropdown-content">
  ...
  <img src="img/step2.png" alt="step2"/><hr noshade>
    ...
    <form style="margin-top:20px;"  action="StandardRoomDetails.php" method = "post">
  ...
  <div class="row">
    ...
    <h5 style="margin-top:20px;">
      <input type="text" name="user_roomtype" value= "Standard"  style=" width:100px;border:none; font-size:25px ;background:transparent;" readonly > Room Details</h5>
         
      
    <hr>
      <div class="row">
        <div class="col s6">
          <h6 style="padding:10px; background-color:gray; color:white;">Standard Room (Php  <input type="text" name="user_roomcharge" value= "1000"  style=" width:34px;border:none; font-size:25px background:transparent;" readonly > .00/night)</h6>
          <img style="width:640px; height:478px"  src="img/StandardRoom/Standard.jpg">
        </div>
        ...
        <div class="col s3">
          <div class="card grey darken-2" style="border:4px solid #ffc400;">
            <div class="card-content white-text" align="center"> 
              ...
              <h5 class="amber-text text-accent-3" style="padding:26px; "> Php 1,000.00/night</h5>
            </div>
          </div>
        </div>
  ...
  <center>
    <div class="carousel">
     <center><h4>Room Pictures</h4></center>
      <a class="carousel-item" href="#one!"><img src="img/StandardRoom/Standard.jpg" style="width:400px;"></a>
      <a class="carousel-item" href="#three!"><img src="img/StandardRoom/StandardCr.jpg" style="width:400px;"></a>
    </div>
  </center>
