...
include("Session.php");
include("connect.php");
$query = "SELECT user_name,  user_arrival , user_roomcharge,user_extraperson, user_departure ,user_deposit,user_roomtype ,user_rembalance ,user_adults , user_children , user_numrooms,user_numnights ,user_totalcharge FROM `users`WHERE user_name = '$login_session'";
