...
include("Session.php");
include("connect.php");
$query = "SELECT user_name,  user_arrival , user_roomcharge, user_departure ,user_deposit,user_roomtype ,user_rembalance ,user_adults , user_children , user_numrooms,user_numnights ,user_totalcharge FROM `users`WHERE user_name = '$login_session'";
...
<br><br>
      ...
      <a class="waves-effect waves-light btn modal-trigger red darken-4 right" href="#modal1">Confirm Booking</a>
        ...
        <div id="modal1" class="modal">
          ...
          <center><h5 >Thank you for booking with DL Divine Inn! 
          <br>
          <br>We have sent you an email of the information concerning your reservation.</h5></center>
    </div>
