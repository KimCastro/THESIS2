...
<head>
  ...
  <title>DL Divine | Standard Room Details</title>
...
<body>
  ...
  <nav class="red darken-4" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul id="nav-mobile" class="side-nav">
        <li><a href="index.htmla">Home</a></li>
        <li><a href="#">About us</a></li>
        <li><a href="#">Rooms</a></li>
        <li><a href="#">Gallery</a></li>
  ...
  <div class="row">
    ...
    <h5 style="margin-top:20px;">Standard Room Details</h5>
    <hr>
      <div class="row">
        <div class="col s6">
  ...
  <div class="row">
    <div class="col s12">
      ...
      <a href="guestinfo.php" style="float:right;" class="waves-effect waves-light btn red darken-4"><i class="material-icons right">fast_forward</i>Continue</a>
    </div>
  </div>
