...
$query = "SELECT * FROM rooms where RoomType = 'frontview'   ";
  ...
  <!--.........content here ........-->
      ...
      <br>
             ...
             <li><a href="roomavailabilityall.php">All</a></li
                      <li><a href="roomavailability.php">Quad</a></li>
...
<center><h1>Available room and rates </h1></center>
        <?php while($row = mysqli_fetch_array($result)):?>
                   ...
                   <article>  
                               <form class = "form" action="roomavailabilityfamily.php" method = "post" >
                                <div style="border:1px solid teal; padding:10px; border-radius:1em; font-size:20px;">
                             
                                 <?php echo "<img width='170' height ='170' src='room/front/".$row['Img']." ' alt='Profile pic'>"; ?>  
                            ...
                            Room Floor: <input type="text" name="floor" value = "<?php echo($row['RoomFloor']);?>"  style=" border:none; background:transparent;  font-weight: bold;"readonly> 
                              ...
                              <input style="background-color: green; color:white; height:50px;width:90px;" type="submit" name="Delete"  value = "<?php echo ($row['RoomStatus']);?>" >
                               </div>
                              
 <input type="hidden" name="number"  value = "<?php echo ($row['Img']);?>"  style=" border:none; background:transparent;  font-weight: bold;" readonly>
                               </form>
                                     </article>         
                            </tr>
                        <?php endwhile;?>
