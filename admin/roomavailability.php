...
$query = "SELECT * FROM rooms where RoomType = 'standard'";
...
<div class="margin10 no-margin-top grid condensed">
  ...
  <!--.........content here ........-->
      ...
      <br>
                ...
                <li><a href="roomavailabilityquad.php">All</a></li
                   ...
                   <article>  
                               <form class = "form" action="roomavailability.php" method = "post" >
                                <div style="border:1px solid teal; padding:10px; border-radius:1em;  font-size:20px;">
                                 ...
                                 <?php echo "<img width='170' height ='170' src='room/Standard/".$row['Img']." ' alt='Profile pic'>"; ?>  
