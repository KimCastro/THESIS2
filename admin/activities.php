...
$hostname = "localhost";
   ...
   $query = "INSERT INTO `activities` (`activities`,`date`) VALUES ('$activities', '$date')";
   ...
   if($result)
   {
      echo "<script>alert('Activities Posted')</script>";
   }else{
...
<head>
  ...
  <title>DL Divine | Activities</title>
...
<br>
 ...
 <div class="col s9">
<div class = "row">
<form class = "col s12"  action="activities.php" method = "post">
<div class = "row">
<div class = "input-field col s12 ">
<h5>Post activities here! </h4>
<textarea  id= "textarea1"  name = "activities" class = "materialize-textarea" required=""></textarea>

<input class="green waves-effect waves-light btn" style="width:140px; " type="submit" name="Post" value ="Post" >

<input  style=" float:right;  border:none; background:transparent;"  name="date" value =" <?php
