...
$query = "SELECT * FROM rooms where RoomType = 'quad'";
        ...
        <?php while($row = mysqli_fetch_array($result)):?>
                   ...
                   <article>  
                            ...
                            Room Floor: <input type="text" name="floor" value = "<?php echo($row['RoomFloor']);?>"  style=" border:none; background:transparent;  font-weight: bold;"readonly> 
                              ...
                              <input style="background-color: red; color:white; height:50px;width:90px;" type="submit" name="Delete"  value = "<?php echo ($row['RoomStatus']);?>" >
                               </div>
