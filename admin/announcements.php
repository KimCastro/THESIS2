...
$hostname = "localhost";
   ...
   $query = "INSERT INTO `announcements` (`announcement`,`date`) VALUES ('$announcement', '$date')";
...
<head>
  ...
  <title>DL Divine | Announcements</title>
...
<div class = "row">
<form class = "col s12"  action="announcements.php" method = "post">
<div class = "row">
<div class = "input-field col s12 ">
<h5>Post announcements here! </h4>
<textarea  id= "textarea1"  name = "announcement" class = "materialize-textarea" required=""></textarea>
