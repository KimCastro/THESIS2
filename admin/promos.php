...
$hostname = "localhost";
   ...
   $query = "INSERT INTO `promos` (`promos`,`date`) VALUES ('$promos', '$date')";
   ...
   if($result)
   {
      echo "<script>alert('Promos Posted')</script>";
   }else{
...
<div class = "row">
<form class = "col s12"  action="promos.php" method = "post">
<div class = "row">
<div class = "input-field col s12 ">
<h5>Post new promos here! </h4>
<textarea  id= "textarea1"  name = "promos" class = "materialize-textarea" required=""></textarea>
