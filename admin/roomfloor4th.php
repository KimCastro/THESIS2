...
$query = "SELECT * FROM rooms where RoomFloor = '4th' "  ;
        ...
        <?php while($row = mysqli_fetch_array($result)):?>
                   ...
                   <article>  
                               <form class = "form" action="roomavailabilityfamily.php" method = "post" >
                                <div style="border:1px solid teal; padding:10px; border-radius:1em;">
                             
                                 <?php echo "<img width='150' height ='150' src='room/".$row['Img']." ' alt='Profile pic'>"; ?>  
