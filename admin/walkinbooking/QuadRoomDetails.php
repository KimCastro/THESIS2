...
<ul id="dropdown1" class="dropdown-content">
 ...
 <form  action="QuadRoomDetails.php" method = "post">
  ...
  <div class="row">
    ...
    <h5 style="margin-top:20px;"> <input type="text" name="user_roomtype" value= "Quad"  style=" width:65px;border:none; font-size:25px ;background:transparent;" readonly >Room Details</h5>

  
    <hr>
      <div class="row">
        <div class="col s6">
          <h6 style="padding:10px; background-color:gray; color:white;">Quad Room (Php<input type="text" name="user_roomcharge" value= "1500"  style=" width:34px;border:none; font-size:25px background:transparent;" readonly >.00/night)</h6>

  
          <img style="width:640px; height:478px"  src="img/QuadRoom/Quad.jpg">
        </div>
        ...
        <div class="col s3">
          <div class="card grey darken-2" style="border:4px solid #ffc400;">
            <div class="card-content white-text" align="center"> 
              ...
              <p class="grey" style="padding:20px;"> 3-4 pax
              <br>1 Double Deck
...
<!--end of 3rd a column card -->
  ...
  <!--end of 3rd column card(Policies)-->
    ...
    <!--end of form for the 1st,2nd and 3rd column cards-->
     <input   class="waves-effect waves-light btn red darken-4" style="float:right;" type="submit" name="Continue" value ="Continue">
